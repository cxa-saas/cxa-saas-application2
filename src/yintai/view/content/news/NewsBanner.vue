  ...
  .newsbanner {
    ...
    .context {
      ...
      .sub-title {
        ...
        h3 {
          font-size: 22px;
          font-family: "SourceHanSansCN-Regular" Lucida, sans-serif !important;
          font-weight: 400;
          color: #ffffff;
          // text-shadow: 0px 2px 3px rgba(4, 0, 0, 0.93);
...
<template>
  <div class="newsbanner" ref="news_banner">
    <transition name="fade-in-up">
      <div v-show="this.active" class="context">
        <div class="newsbanner-title"><h1>银泰新闻</h1></div>
...
export default {
  ...
  mounted() {
    ...
    this.distance = this.$refs.news_banner.getBoundingClientRect().bottom;
