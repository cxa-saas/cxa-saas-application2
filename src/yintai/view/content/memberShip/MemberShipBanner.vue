...
@media screen and (min-width: 55rem) {
  .membershipbanner {
    margin-top: 4.5rem;
    width: 100%;
    background-image: url("/media/yintai/membership-1.png");
...
<template>
  <div class="membershipbanner" ref="membershipbanner">
    <transition name="fade-in-up">
      <div v-show="this.active" class="context">
        <div class="membershipbanner-title"><h1>INTIME365会员</h1></div>
        <div class="sub-title"><h3>您的一站式购物娱乐专家</h3></div>
      </div>
    </transition>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    this.distance = this.$refs.membershipbanner.getBoundingClientRect().bottom;
  ...
  methods: {
    getDistance() {
      this.distance =
        this.$refs.membershipbanner.getBoundingClientRect().bottom;
