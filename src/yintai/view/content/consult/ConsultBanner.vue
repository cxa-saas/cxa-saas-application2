...
@media screen and (min-width: 55rem) {
  .cloudpictureanner {
    margin-top: 4.5rem;
    width: 100%;
    background-image: url("/media/yintai/consult-1.png");
...
<template>
  <div class="cloudpictureanner" ref="cat_banner">
    <transition name="fade-in-up">
      <div v-show="this.active" class="context">
        <!-- <div class="cloudpictureanner-title"><h1>银泰云图</h1></div>
        <div class="sub-title"><h3>传递生活新美学</h3></div>
        <GetMore></GetMore> -->
      </div>
    </transition>
  </div>
...
export default {
  ...
  mounted() {
    ...
    this.distance = this.$refs.cat_banner.getBoundingClientRect().bottom;
