...
<template>
  <div class="newsinngerbanner" ref="newsinnger_banner">
    <transition name="fade-in-up">
      <div v-show="this.active" class="context">
        <div class="newsinngerbanner-title"><h1>银泰新闻</h1></div>
        <div class="sub-title"><h3>对外传播阵地</h3></div>
      </div>
    </transition>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    this.distance = this.$refs.newsinnger_banner.getBoundingClientRect().bottom;
