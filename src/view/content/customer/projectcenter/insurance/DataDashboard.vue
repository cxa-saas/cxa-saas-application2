<template>
  ...
  >
    ...
    <div class="card-header border-0 py-5">
      <h3 class="card-title font-weight-bolder text-white">2020年CXA年度保险计划</h3>
      ...
      <div class="card-spacer bg-white card-rounded flex-grow-1">
        ...
        <div class="row m-0">
          ...
          <div class="col px-8 py-6">
            ...
            <div class="font-size-h4 font-weight-bolder">4</div>
          </div>
        </div>
        <!--end::Row-->
        <!--begin::Row-->
        <div class="row m-0">
          <div class="col px-8 py-6 mr-8">
            ...
            <div class="font-size-h4 font-weight-bolder">100</div>
          </div>
          <div class="col px-8 py-6">
            <div class="font-size-sm text-muted font-weight-bold">
              Register Employee
            </div>
            <div class="font-size-h4 font-weight-bolder">80</div>
          </div>
        </div>
        <!--end::Row-->
      </div>
