              ...
              <div class="pb-5" data-wizard-type="step-content">
                ...
                <div class="form-group">
                  ...
                  <input
                    ...
                    value="LouShangGuanRoad ChangNing ShangHai"
                  />
                  <span class="form-text text-muted"
                    >Please enter your compang address.</span
                  >
                </div>

                <div class="form-group">
                  <label>Select an Industry Option</label>
                  <select
                    name="preferreddelivery"
                    class="form-control form-control-solid form-control-lg"
                  >
                    <option value="morning" selected>Internet Industry</option>
                    <option value="afternoon">Manufacturing</option>
                    <option value="evening">Government Department</option>
                  </select>
                </div>
              </div>
              <!--end: Wizard Step 2-->
